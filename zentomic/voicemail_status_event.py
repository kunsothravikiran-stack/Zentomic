...
def resolve_voicemail_recording_status_event(
    ...
    RecordingUrl and unrelated fields are ignored and never returned. This
    helper performs no persistence, retrieval, acknowledgement, or I/O.
    """
    ...
    return _resolve_fields(fields, max_length=max_length)
...
def resolve_claimed_voicemail_recording_status_event(
    ...
    a durable, workspace-authorized claim. This helper performs no I/O.
    """
    _validate_voicemail_max_length(max_length)
    ...
    result = _resolve_fields(fields, max_length=max_length)
